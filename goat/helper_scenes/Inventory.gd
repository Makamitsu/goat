...
func _ready():
	...
	goat_inventory.connect("item_added",Callable(self,"_on_item_added"))
	goat_inventory.connect("item_removed",Callable(self,"_on_item_removed"))
	goat_inventory.connect("item_replaced",Callable(self,"_on_item_replaced"))
	goat_voice.connect("started",Callable(self,"_on_voice_changed"))
	goat_voice.connect("finished",Callable(self,"_on_voice_changed"))
	
	inventory_items.rotation_reset_requested.connect(self._on_rotation_reset_requested)
